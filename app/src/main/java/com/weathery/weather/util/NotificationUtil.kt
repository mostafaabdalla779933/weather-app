...
import com.weathery.weather.model.getDate


class NotificationUtil(var alertsItem: AlertsItem):ContextWrapper(com.weathery.weather.MyApplication.getContext()) {
